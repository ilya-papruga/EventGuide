package by.it_academy.jd2.user.controllers.advices;


import by.it_academy.jd2.user.core.dto.error.SingleError;
import by.it_academy.jd2.user.core.dto.error.FieldError;
import by.it_academy.jd2.user.core.dto.error.MultiplyError;
