package by.it_academy.jd2.user.controller.advices;


import by.it_academy.jd2.user.dto.error.SingleError;
import by.it_academy.jd2.user.dto.error.FieldError;
import by.it_academy.jd2.user.dto.error.MultiplyError;
